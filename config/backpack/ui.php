...
//    'view_namespace_fallback' => 'backpack.theme-tabler::',
    ...
    */
    ...
    'project_logo'   => '
                    <div style="transition:.07s;filter: opacity(40%);" onMouseOut="this.style.filter=\'opacity(40%)\'" onMouseOver="this.style.filter=\'opacity(90%)\'">
                        <i class="las la-lg la-clipboard text-primary" style="transform: rotate(-15deg);"></i>
                        <span class=""><b>MU</b>-<span class="text-primary">Updates</span> Panel<span>
                    </div>',
    ...
    'developer_name' => 'Mzumbe University',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'site.mzumbe.ac.tz',
